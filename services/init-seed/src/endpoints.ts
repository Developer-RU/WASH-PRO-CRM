...
const cardFields: SchemaField[] = [
  ...
  { name: 'discountType', type: 'string', order: 4, description: 'Тип скидки' },
  { name: 'status', type: 'string', order: 5, description: 'active|blocked|expired' },
  { name: 'washId', type: 'string', order: 6 },
  { name: 'postId', type: 'string', order: 7 },
